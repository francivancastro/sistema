...
class AlunoModel_sisgef extends Model{
    ...
    public function pegaAlunoPorPessoa($id){
        if($id){
        ...
        $msg = array();
            ...
            if($this->data_inicio > $this->data_fim){
                $msg[] = $msgs->erro("Data de Inicio de Curso é Maior que a Data Final!");
            }
    ...
    public function alterar(){
        return $this->atualizar(array("id_pessoa" => $this->id_pessoa,
                                     ...
                                     "semestre" => $this->semestre,
                                     "data_fim" => $this->data_fim,
                                  "data_inicio" => $this->data_inicio), $this->id_aluno);
    }
}
